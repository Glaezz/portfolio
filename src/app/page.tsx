      ...
      <FadeContent blur={true} duration={1000} easing="ease-out" initialOpacity={0}>
              ...
              <div className="h-screen px-6 sm:px-10 md:px-20  flex flex-col w-full">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:justify-between mb-12">
                  <div className="hidden sm:flex gap-4">
                    ...
                    <a href="https://github.com/glaezz" className="text-primary font-light hover:-translate-y-1 transition">GITHUB</a>
                    <a href="https://www.instagram.com/glaezz_/" className="text-primary font-light hover:-translate-y-1 transition">INSTAGRAM</a>
                  </div>
        ...
        <section className="w-full bg-white dark:bg-[#0B0B0D] p-6 sm:p-20">
          ...
          <div className="w-full flex flex-col sm:flex-row gap-8">
            ...
            <div className="w-full sm:w-[70%] flex justify-center items-center text-md lg:text-xl">
              {DATA.summary}
            </div>
          </div>
        </section>
